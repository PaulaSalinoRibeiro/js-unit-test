...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('função retorna o objeto correto para o parâmetro "Melissandre"', () => {
  ...
  it('os parâmetros não são Case Sensitive.', () => {
    expect(getCharacter('ARYA')).toEqual({ name: 'Arya Stark', class: 'Rogue', phrases: ['Not today', 'A girl has no name.']});
  });
  it('ao passar um nome que não está na tabela, a função retorna undefined', () => {
    expect(getCharacter('Paula')).toBeUndefined();
  });
});
